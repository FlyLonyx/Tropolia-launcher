...
class Login {
    ...
    async loginAzuriom() {
        ...
        registerMojangBtn.addEventListener("click", () => {
            shell.openExternal("https://tropolia.fr/user/register");
            
            //document.querySelector(".login-card-mojang").style.display = "none";
            //document.querySelector(".login-card-register").style.display = "flex";

        })
        oublieBtn.addEventListener("click", async () => {
            shell.openExternal("https://tropolia.fr/user/password/reset");
        })
